...
let famous_person = "John Kennedy";
let message = "Ask not what your country can do for you; ask what you can do for your country.";
console.log(chalk.italic.rgb(159, 168, 218)(`${famous_person} once said,"${message}"`));
